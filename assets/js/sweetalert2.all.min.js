...
const alertplus = (title, message, button = "success", showConfirmButton = true) => {Swal.fire({title: title,text: message,icon: button,confirmButtonText: "متوجه شدم!",showConfirmButton:showConfirmButton,customClass: {container: "z-full",confirmButton: "btn btn-primary"}});}